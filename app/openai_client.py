...
AIPROXY_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIzZHMyMDAwMDY1QGRzLnN0dWR5LmlpdG0uYWMuaW4ifQ.-UEa1J8E411bN67cRkey68jCVph9hhyO3H9HMxOw7og"
...
async def get_openai_response(question: str, file_path: Optional[str] = None) -> str:
    ...
    if (
        ...
        from app.functions import convert_keyvalue_to_json
    ...
    if (
        ...
        from app.functions import process_encoded_files
