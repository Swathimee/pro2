...
from app.filehandler import save_upload_file_temporarily
import httpx
import json
...
async def send_multipart_request(file_path: str):
    ...
    try:
        with open(file_path, "rb") as file:
            files = {"file": (file_path, file, "application/zip")}  # Specify content type as application/zip
...
if __name__ == "__main__":
    ...
    # You can call the send_multipart_request function here if you want
    # to execute it when the FastAPI app starts (for testing purposes).
    # Be mindful that this will run concurrently with the FastAPI app.
    # asyncio.create_task(send_multipart_request("abcd.zip"))